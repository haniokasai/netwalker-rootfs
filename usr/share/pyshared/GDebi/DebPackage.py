...
class DebPackage(object):
    ...
    def checkDeb(self):
        ...
        host_arch = apt_pkg.Config.Find("APT::Architecture")
        if  arch != "all" and arch != host_arch and \
            (host_arch not in ALLOWED_ARCHES or arch not in ALLOWED_ARCHES[host_arch]):
