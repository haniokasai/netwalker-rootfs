...
class AbstractUI(dbus.service.Object):
    ...
    def main_window_text(self):
        ...
        if proprietary_available:
            ...
            'these drivers.') % {'os': OSLib.inst.os_vendor}
        else:
            subtext = ''
    ...
    def ui_init(self):
        ...
        This should load the GUI components, such as glade files, but not show
        the main window yet; that is done by ui_show_main().
        '''
        raise NotImplementedError, 'subclasses need to implement this'
