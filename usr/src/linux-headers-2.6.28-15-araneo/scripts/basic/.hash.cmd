cmd_scripts/basic/hash := gcc -Wp,-MD,scripts/basic/.hash.d -Iscripts/basic -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -o scripts/basic/hash scripts/basic/hash.c  
