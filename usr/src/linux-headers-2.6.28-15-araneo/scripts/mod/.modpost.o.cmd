cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Iscripts/mod -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -c -o scripts/mod/modpost.o scripts/mod/modpost.c
