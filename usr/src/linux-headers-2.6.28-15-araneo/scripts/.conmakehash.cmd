cmd_scripts/conmakehash := gcc -Wp,-MD,scripts/.conmakehash.d -Iscripts -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -o scripts/conmakehash scripts/conmakehash.c  
