/*
 * This was automagically generated from /build/buildd/linux-fsl-imx51-2.6.28/arch/arm/tools/mach-types!
 * Do NOT edit
 */
...
#define MACH_TYPE_KIRKWOOD_PLUG        2097
...
#ifdef CONFIG_MACH_KIRKWOOD_PLUG
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_KIRKWOOD_PLUG
# endif
# define machine_is_kirkwood_plug()	(machine_arch_type == MACH_TYPE_KIRKWOOD_PLUG)
#else
# define machine_is_kirkwood_plug()	(0)
#endif
