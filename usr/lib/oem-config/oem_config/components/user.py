...
class User(FilteredCommand):
    def prepare(self, unfiltered=False):
        ...
        questions = ['^passwd/user-fullname$', '^passwd/username$',
                     ...
                     '^user-setup/password-weak$', '^user-setup/user-setup$',
                     'ERROR']
    ...
    def run(self, priority, question):
        ...
        if question.startswith('user-setup/user-setup'):
            response = self.frontend.question_dialog(
                self.description('oem-config/text/user-setup'),
                self.extended_description('oem-config/text/user-setup'),
