...
//@line 41 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 244 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
...
//@line 251 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 267 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
      aLeafName = appName.toLowerCase();
//@line 270 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
...
//@line 341 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
...
//@line 348 "/build/buildd/xulrunner-1.9-1.9.0.14+build2+nobinonly/mozilla/xulrunner/setup/nsXULAppInstall.js"
  }
};
